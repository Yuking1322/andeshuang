...
echo.
echo Docker Desktop
echo Docker Desktop >> "%LOGFILE%"
echo 说明: 建议按 Docker 官方 Windows 文档安装，避免 WSL2 / Hyper-V 细节被一键脚本掩盖。
echo 说明: 建议按 Docker 官方 Windows 文档安装，避免 WSL2 / Hyper-V 细节被一键脚本掩盖。 >> "%LOGFILE%"
echo 官方入口: https://docs.docker.com/desktop/setup/install/windows-install/
echo 官方入口: https://docs.docker.com/desktop/setup/install/windows-install/ >> "%LOGFILE%"
echo.
