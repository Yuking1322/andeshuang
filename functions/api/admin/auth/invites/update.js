...
import { getLocalAuthAdminSnapshot, LocalAuthError, updateLocalAuthInvite } from '../../../../_shared/local-auth.js'
...
export async function onRequestPost(context) {
  ...
  try {
    await updateLocalAuthInvite(context.env.AUTH_DB, body.value)
