...
import { createLocalAuthInvite, getLocalAuthAdminSnapshot, LocalAuthError } from '../../../../_shared/local-auth.js'
...
export async function onRequestPost(context) {
  ...
  try {
    const invite = await createLocalAuthInvite(
      context.env.AUTH_DB,
      body.value,
